...
const Navbar = () => {
  return (
    <header className="flex border-b py-4 px-4 sm:px-10 bg-white font-sans min-h-[70px] tracking-wide fixed top-0 left-0 right-0 z-50">
      <div className="flex flex-wrap items-center gap-4 w-full">
        <a href="https://readymadeui.com">
          <h3 className="logo-page text-2xl font-semibold">CreateMyEvent</h3>
        </a>
            ...
            <ul className="lg:flex lg:gap-x-8 max-lg:space-y-2">
              <li className="mb-6 hidden max-lg:block">
                <a href="javascript:void(0)">
                  <img src="https://readymadeui.com/readymadeui." alt="logo" className="craftmyevent-logo w-36" />
                </a>
              </li>
              <li className="max-lg:border-b max-lg:py-3">
                <a href="javascript:void(0)" className="hover:text-[#007bff] text-[#007bff] block font-bold text-[15px]">
                  Home
                </a>
              </li>
              <li className="max-lg:border-b max-lg:py-3">
                <a href="javascript:void(0)" className="hover:text-[#007bff] text-gray-600 block font-bold text-[15px]">
                  Shop
                </a>
              </li>
              <li className="max-lg:border-b max-lg:py-3">
